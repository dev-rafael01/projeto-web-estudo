package educadoweb.curso.config;
...
import educadoweb.curso.repositories.OrderItemRepository;
...
public class TestConfing implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception 
    {
       ...
       Product p1 = new Product(0, "The Lord of the Rings", "Lorem ipsum dolor sit amet, consectetur.", 90.5, ""); 
        ...
        Order o1 = new Order(0, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.AGUARDANDO_PAGAMENTO, u1); 
        Order o2 = new Order(0, Instant.parse("2019-07-21T03:42:10Z"), OrderStatus.PAGO, u2); 
        Order o3 = new Order(0, Instant.parse("2019-07-22T15:21:22Z"), OrderStatus.PAGO, u1); 
